...
\projectinfo{
  ...
  title.cs={Robotický včelař},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Robotic Beekeeper}, % název práce v angličtině / thesis title in english
  ...
  %Autor / Author
  author.name={Eliška},   % jméno autora / author name
  author.surname={Křeménková},   % příjmení autora / author surname 
  ...
  declaration={Prohlašuji, že jsem tuto bakalářskou práci vypracovala samostatně pod vedením pana doc. RNDr. Pavla Smrže, Ph.D. Pro jazykovou revizi technické zprávy jsem použila nástroj ChatGPT. Uvedla jsem všechny literární prameny, publikace a další zdroje, ze kterých jsem čerpala.},
...
% I have listed all the literary sources, publications and other sources, which were used during the preparation of this thesis. I have used ChatGPT to correct spelling and other language mistakes. I used GitHub Copilot when working on the software. [specify and ammend based on reality].},
  ...
  acknowledgment={Ráda bych poděkovala vedoucímu bakalářské práce, panu doc. RNDr. Pavlu Smržovi, Ph.D., za odborné vedení, cenné rady a připomínky při řešení této práce. Poděkování patří také Petru~Křeménkovi, mému otci, za možnost testování zařízení na jeho včelstvu a Lukáši~Lenčešovi za zapůjčení technického vybavení.},
